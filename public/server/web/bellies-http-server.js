...
export default class BelliesHttpServer {
    constructor() {
        ...
        this.staticResources = [
            {path : "/", loc : "public"},
            {path : "/bellies/resources", loc : "public/client/resources"},
            {path : "/bellies/app", loc : "public/client/app"},
            {path : "/bellies/unify", loc : "public/client/resources/theme/Unify-v1.7/HTML/assets"}
        ];
    ...
    _setupTerminationHandlers() {
        ...
        ['SIGHUP', 'SIGINT', 'SIGQUIT', 'SIGILL', 'SIGTRAP', 'SIGABRT', 'SIGBUS', 'SIGFPE', 'SIGUSR1', 'SIGSEGV',
            ...
            process.on(element, function() {
                BelliesHttpServer.terminator(element);
            });
        });
    }
